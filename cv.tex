...
\begin{tabularx}{\textwidth}{l l l}
   ...
   \multicolumn{3}{l}{\textcolor{seaborn_bg_grey_half}{\large \textbf{Skills}}}                                                                                                                                                                                                                                                                                                   \\\noalign{\vskip-0.1pt}
   \rowcolor{seaborn_bg_grey}
   \textbf{\textit{Programming}} &                                                                                                                                                                        &                                                                                                                                                                \\\noalign{\vskip-0.1pt}
   \multicolumn{3}{X}{\cellcolor{seaborn_bg_grey}%
   I am a confident programmer, with experience in various languages (mostly Python and Fortran) implementing complex algorithms (mostly in the context of electronic structure calculations). I routinely employ good programming practices such as testing, documentation, and CI/CD.
   }                                                            \\\noalign{\vskip-0.1pt}
   ...
   2013
                                 ...
                                 & University of Otago                                                                                                                                                                                                                                                                                                                     \\\noalign{\vskip-0.1pt}
   \rowcolor{seaborn_bg_grey}
   \multicolumn{3}{X}{\cellcolor{seaborn_bg_grey}\textbf{\textit{Supervision and mentoring}}}                                                                                                                                                                                                                                                                             \\\noalign{\vskip-0.1pt}
   \multicolumn{3}{X}{\cellcolor{seaborn_bg_grey}During my postdoc I have supervised the Masters project and dissertation of Yannick Schubert. He said that ``thanks to (Edward's) good choice of topics and guidance... achieving good results felt easy. Working with (Edward) was very motivating and a perfect start to a scientific career.'' One preprint has resulted from this work (with another in preparation).}                                                                                                                                                                                                                       \\*\noalign{\vskip-0.1pt}
   \multicolumn{3}{X}{\cellcolor{seaborn_bg_grey}I also helped Hovan Lee (PhD student from King's College London) with his DMFT calculations on transferrin. A paper resulted from this work, of which I am the last author.}                                                                                                                                        \\*\noalign{\vskip-0.1pt}
   \multicolumn{3}{X}{\cellcolor{seaborn_bg_grey}During the course of my PhD I provided support to two students. I spent a significant amount of time with M.\,A.\,Al-Badri (Masters, and then PhD student from King's College London), teaching him about DMFT and working with him on DMFT calculations on hemocyanin. I have hosted him in Cambridge twice, and visited him at KCL periodically. A paper resulted from this work. I was also the local port-of-call for S. Mansur (PhD student, Cambridge) for support running ONETEP calculations. This work resulted in two publications.}                                                                                                                                                            \\\noalign{\vskip-0.1pt}
   \rowcolor{seaborn_bg_grey_half}
   \textbf{\textit{Outreach}}    &                                                                                                                                                                        &                                                                                                                                                                \\
   \rowcolor{seaborn_bg_grey_half}
   \multicolumn{3}{X}{\cellcolor{seaborn_bg_grey_half}I have assisted at several information days at EPFL and at Cambridge, introducing high school students to computational materials science research.}
\end{tabularx}
...
\begin{tabularx}{\textwidth}{
   ...
   %}
   \\
   Y.\,Schubert, N.\,Marzari, \textbf{EBL}, \href{https://arxiv.org/abs/?????}{\textit{Testing Koopmans spectral functionals on the analytically-solvable Hooke's atom}}. arXiv:????.????? (2022)
   \\
